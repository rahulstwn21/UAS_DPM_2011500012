package com.example.uas_dpm_2011500012

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.widget.*

class MemasukanDataDosen : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_memasukan_data_dosen)
        ...
        btnSimpan.setOnClickListener {
            if ("${etNIDN.text}".isNotEmpty() && "${etNmDosen.text}".isNotEmpty() &&
                ...
                val db = Database(this@MemasukanDataDosen)
                db.Nidn = "${etNIDN.text}"
